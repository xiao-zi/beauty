            ...
            <ul class="pullDown-nav">
                <li class="pullDown-nav-item">
                    ...
                    <dl class="pullDown-nav-child">
                        <?php switch($vo["status"]): case "1": ?><dd><a href="javascript:;" style="background-color: #00a65a;" onclick="sendMail(<?php echo ($vo["id"]); ?>)"><?php echo ($language["Resend"]); ?></a></dd><?php break;?>
                            <?php case "2": ?><dd><a href="javascript:;" style="background-color: #00a65a;" onclick="sendMail(<?php echo ($vo["id"]); ?>)"><?php echo ($language["Resend"]); ?></a></dd><?php break;?>
