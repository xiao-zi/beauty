    ...
    <form class="layui-form" id="form" action="">
        <div class="layui-col-md12">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="chinese" placeholder="<?php echo ($language["Chinese-title"]); ?>"  readonly value="<?php echo ($info["chinese"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo ($language["English-title"]); ?>：<b style="color:#d70101">*</b></label>
                <div class="layui-input-block">
                    <input name="english" placeholder="<?php echo ($language["English-title"]); ?>" readonly  value="<?php echo ($info["english"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
            <div class="layui-form-item">
                            ...
                            <tr>
                                ...
                                <th data-field="price" data-key="1-0-1" class="">
                                    <div class="layui-table-cell laytable-cell-1-0-2">
                                        <input name="total" placeholder="0.00"  value="<?php echo ($info["original"]); ?>" autocomplete="off" class="layui-input priceTol" type="text">
                                    </div>
                                </th>
                            </tr>
                            </thead>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="present" placeholder="<?php echo ($language["present"]); ?>"  value="<?php echo ($info["present"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo ($language["Term-validity"]); ?>：<b style="color:#d70101">*</b></label>
                <div class="layui-input-block">
                    <input name="date" placeholder="<?php echo ($language["Term-validity"]); ?>"  value="<?php echo ($info["date"]); ?>" autocomplete="off" class="layui-input" type="text">
        ...
        <div class="layui-form-item layui-layout-admin">
            <div class="layui-footer" style="left: auto;">
                <a class="layui-btn" onclick="subUpdate()"><i class="layui-icon">&#xe605;</i><?php echo ($language["Submission"]); ?> </a>
    ...
    <script>
        ...
        function subUpdate(){
            $.ajax({
                cache: true,
                type: 'POST',
                url:'/admin.php/Package/update?id='+<?php echo ($info['id']); ?>,
