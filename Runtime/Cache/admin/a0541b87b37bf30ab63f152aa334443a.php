...
<form class="layui-form" id="form">
    ...
    <div class="layui-tab-item layui-show">
        ...
        <input name="id"  value="<?php echo ($id); ?>" autocomplete="off" class="layui-input" type="hidden">

        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label"><?php echo ($language["model"]); ?>：<b style="color:#d70101">*</b></label>
                <div class="layui-input-block">
                    <input name="model" placeholder="<?php echo ($language["please-input-model"]); ?>" value="<?php echo ($info["model"]); ?>" readonly autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input name="chinese" placeholder="<?php echo ($language["please-input-chinese"]); ?>" value="<?php echo ($info["chinese"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input name="english" placeholder="<?php echo ($language["please-input-english"]); ?>" value="<?php echo ($info["english"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
        </div>
    </div>
...
<script>
    function subData(){
        $.ajax({
            cache: true,
            type: 'POST',
            url:'/admin.php/Language/updateLanguageData',
