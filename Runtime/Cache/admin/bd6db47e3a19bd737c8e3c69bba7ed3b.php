...
<body>
    ...
    <form class="layui-form" id="form" action="">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" class="layui-table" lay-even="">
                            ...
                            <tr>
                                ...
                                <th data-field="price" data-key="1-0-2" class="">
                                    <div class="layui-table-cell laytable-cell-1-0-2"><span><?php echo ($language["Total-price"]); ?>:</span><span class="priceTol">0.00</span></div>
                                </th>
                                <th data-field="tip" data-key="1-0-3" class="">
                                    <div class="layui-table-cell laytable-cell-1-0-3"><span><?php echo ($language["Tip-price"]); ?>:</span><span class="tipTol">0.00</span></div>
                                </th>
                                <th data-field="tempId" data-key="1-0-4" class="">
                                    <div class="layui-table-cell laytable-cell-1-0-4"><span><?php echo ($language["total"]); ?>:</span><span class="allTol">0.00</span></div>
                                </th>
                            </tr>
                            </thead>
                        </table>
        ...
        <div class="layui-col-md4">
            <?php if($config['INTEGRAL-STATUS'] == true): ?><div class="layui-card">
                    <div class="layui-card-header"><?php echo ($language["Integral-exchange"]); ?></div>
                    <div class="layui-card-body">
                        <div class="layui-row layui-col-space10">
                            <div class="layui-form-item">
                                <label class="layui-form-label" ><?php echo ($language["Integral-exchange"]); ?>：</label>
                                <div class="layui-input-block">
                                    <input name="integral" placeholder="<?php echo ($language["Integral-exchange"]); ?>"  value="" autocomplete="off" class="layui-input" type="text">
                                    <div class="layui-form-mid layui-word-aux">可用积分：<span id="Integral">0</span>,可减免：<?php echo ($config['PRICE-UNIT']); ?><span id="money">0</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
