        ...
        <div class="layui-col-md8">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="data[title]" placeholder="<?php echo ($language["title"]); ?>"  value="<?php echo ($coupon["title"]); ?>" autocomplete="off" class="layui-input" type="text">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo ($language["Preferential-mode"]); ?>:<b style="color:#d70101">*</b></label>
                <div class="layui-input-block">
                    <?php switch($coupon["type"]): case "1": ?><input type="radio" name="data[type]" value="1" title="<?php echo ($language["Full-reduction"]); ?>" checked=""><input type="radio" name="data[type]" value="2" title="<?php echo ($language["discount"]); ?>"><?php break;?>
                        <?php case "2": ?><input type="radio" name="data[type]" value="1" title="<?php echo ($language["Full-reduction"]); ?>" ><input type="radio" name="data[type]" value="2" title="<?php echo ($language["discount"]); ?>" checked=""><?php break; endswitch;?>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo ($language["Validity-period-of-coupon"]); ?>：<b style="color:#d70101">*</b></label>
                <div class="layui-input-block">
                    <input type="text" name="data[date]" class="layui-input" id="data" placeholder=" - " value="<?php echo ($coupon["date"]); ?>">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" id="product">
                    <select class="product" name="data[product][]" multiple="multiple" style="width:100%;">
                        <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if(in_array($val['id'],$coupon['product'])): ?>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" id="category">
                    <select class="category" name="data[category][]" multiple="multiple" style="width:100%;">
                        <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if(in_array($val['id'],$coupon['category'])): ?>
                            <option value="<?php echo ($val["id"]); ?>" selected><?php echo ($val["chinese"]); ?>(<?php echo ($val["english"]); ?>)</option>
                            <?php else: ?>
                            <option value="<?php echo ($val["id"]); ?>" ><?php echo ($val["chinese"]); ?>(<?php echo ($val["english"]); ?>)</option>
                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="<?php echo ($language["Notes-on-coupons"]); ?>" name="data[remark]" class="layui-textarea"><?php echo ($coupon["remark"]); ?></textarea>
                </div>
            </div>
        </div>
                    ...
                    <div class="layui-row layui-col-space10">
                        <div class="layui-upload">
                            <div class="layui-upload-list">
                                <img id="demo1"   src="<?php echo ($coupon["img"]); ?>">
                            </div>
                            <input name="data[img]" id="url1"    value="<?php echo ($coupon["img"]); ?>" autocomplete="off" class="layui-input" type="hidden">
    ...
    <script>
        ...
        function updateCoupon(){
            $.ajax({
                cache: true,
                type: 'POST',
                url:'/admin.php/Coupon/updateCoupon/id/'+<?php echo ($coupon['id']); ?>,
