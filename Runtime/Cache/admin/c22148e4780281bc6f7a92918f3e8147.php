...
<body>
        ...
        <div class="layui-field-box">
            <form class="layui-form" method="post" name="search-form2" id="search-form2">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label"><?php echo ($language["email"]); ?>：</label>
                        <div class="layui-input-inline" style="width: 300px;">
                            <input name="keywords"  placeholder="<?php echo ($language["email"]); ?>" class="layui-input" type="text" autocomplete="off">
                        </div>
                    </div>
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend><?php echo ($language["Mailbox-menu-management"]); ?></legend>
    </fieldset>
    ...
    <script>
        ...
        function sendMail(id){
            $.getJSON('/admin.php/Promotion/mailResend',{'id':id},function(json){
                if(json.rel== 1){
                    layer.msg(json.msg, {
                        icon: 1,   // 成功图标
        ...
        function showDetail(id){
            layer.open({
                ...
                ,btn: ['<?php echo ($language["close"]); ?>'] //只是为了演示
                ,yes: function(){
                    layer.closeAll();
                }
            });
