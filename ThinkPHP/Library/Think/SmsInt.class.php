...
class SmsInt {
	...
	const API_ACCOUNT='I2554017';//Get SMS Account  from  https://zz.253.com/site/login.html 

	const API_PASSWORD='nHrvOIx1NJ7350';//Get SMS Password  from https://zz.253.com/site/login.html
	/**
	 * 发送短信
	 *
